...
try:
	...
	def get_party_tax_withholding_details(doc, _tax_withholding_category=None):
		"""Compatibility wrapper for merged v15 custom code on v16 tax withholding API."""
		try:
			PurchaseTaxWithholding(doc).on_validate()
		except Exception:
			frappe.log_error(frappe.get_traceback(), "Purchase Invoice Tax Withholding Compatibility Error")
		return frappe._dict(), [], []
...
try:
	...
	def get_item_account_wise_additional_cost(_purchase_invoice):
		"""Compatibility fallback for merged v15 custom code on v16 purchase receipt API."""
		return {}
...
class PurchaseInvoice(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from iran_utilities.iran_utilities.doctype.payment_schedule.payment_schedule import PaymentSchedule
